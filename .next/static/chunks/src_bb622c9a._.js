...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/date-fns/format.mjs [app-client] (ecmascript) <locals>"); // Renamed to avoid conflict with format prop
...
function DashboardPage() {
    ...
    const [userAccounts, setUserAccounts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [selectedAccountId, setSelectedAccountId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(undefined);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardPage.useEffect": ()=>{
            const fetchAccounts = {
                "DashboardPage.useEffect.fetchAccounts": async ()=>{
                    try {
                        const res = await fetch('/api/accounts');
                        if (!res.ok) throw new Error('Failed to fetch accounts');
                        const allAccountsRaw = await res.json();
                        const allAccounts = allAccountsRaw.map({
                            "DashboardPage.useEffect.fetchAccounts.allAccounts": (acc)=>({
                                    ...acc,
                                    balance: parseFloat(acc.balance),
                                    transactions: acc.transactions || []
                                })
                        }["DashboardPage.useEffect.fetchAccounts.allAccounts"]);
                        if (user && Array.isArray(user.accounts)) {
                            const userAccountIds = user.accounts; // ✅ Now TypeScript knows it's defined
                            const accounts = allAccounts.filter({
                                "DashboardPage.useEffect.fetchAccounts.accounts": (acc)=>userAccountIds.includes(acc.id)
                            }["DashboardPage.useEffect.fetchAccounts.accounts"]);
            ...
            }["DashboardPage.useEffect.fetchAccounts"];
            if (user?.role === 'user') {
                fetchAccounts();
            }
        }
    ...
    const selectedAccount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[selectedAccount]": ()=>{
            return userAccounts.find({
                "DashboardPage.useMemo[selectedAccount]": (acc)=>acc.id === selectedAccountId
            }["DashboardPage.useMemo[selectedAccount]"]);
        }
    }["DashboardPage.useMemo[selectedAccount]"], [
        userAccounts,
    ...
    const filteredTransactions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[filteredTransactions]": ()=>{
            if (!selectedAccount || !Array.isArray(selectedAccount.transactions)) return [];
            let transactions = selectedAccount.transactions;
            if (dateRange?.from) {
                transactions = transactions.filter({
                    "DashboardPage.useMemo[filteredTransactions]": (t)=>new Date(t.date) >= dateRange.from
                }["DashboardPage.useMemo[filteredTransactions]"]);
            }
            if (dateRange?.to) {
                transactions = transactions.filter({
                    "DashboardPage.useMemo[filteredTransactions]": (t)=>{
            ...
            return transactions.sort({
                "DashboardPage.useMemo[filteredTransactions]": (a, b)=>new Date(b.date).getTime() - new Date(a.date).getTime()
            }["DashboardPage.useMemo[filteredTransactions]"]);
        }
    }["DashboardPage.useMemo[filteredTransactions]"], [
        selectedAccount,
    ...
    const handleDownload = (formatType)=>{
        ...
        if (formatType === 'csv') {
            ...
            content += `Transactions (${dateRange?.from ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(dateRange.from, 'MMM dd, yyyy') : 'Start'} - ${dateRange?.to ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(dateRange.to, 'MMM dd, yyyy') : 'End'}):\n`;
            content += "Date,Description,Amount,Currency,Type\n";
            filteredTransactions.forEach((tx)=>{
                content += `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(tx.date), 'yyyy-MM-dd')},"${tx.description.replace(/"/g, '""')}",${tx.amount.toFixed(2)},${tx.currency},${tx.type}\n`;
            });
            content += "\n\n--- End of Report ---";
...
_s(DashboardPage, "tjUQwIe25lotG2b52EtHIBZae3E=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
...
//# sourceMappingURL=src_bb622c9a._.js.map